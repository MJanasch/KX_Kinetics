...
% created:21/02-23, last modified: 21/11-2
...
%% Load the Model
load('Models/GEMs/SYN_GEM_iSyn731_CycleSyn.mat'); % Model from Sarkar, D., Mueller, T. J., Liu, D., Pakrasi, H. B., & Maranas, C. D. (2019). A diurnal flux balance model of Synechocystis sp. PCC 6803 metabolism. PLoS Computational Biology, 15(1), e1006692. https://doi.org/10.1371/journal.pcbi.1006692
