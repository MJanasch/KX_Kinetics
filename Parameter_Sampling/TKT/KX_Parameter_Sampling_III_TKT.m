...
% Created: 2017-03-22, last modified: 2021-10-08

function [DataOut, N] = KX_Parameter_Sampling_III_TKT(iterations,InputDataStructure,MetConcDataIn,MetNames,seed)
...
for c = 1:iterations                    % for every interation
    ...
    [dfodc,Parameters(c,:)] = KX_CalDFODC_TKT(N,Parameters(c,:),vmax_K_indeces,Fluxes,SFull);
