...
% Created: 2017-03-22, last modified: 2021-10-07
...
%% Input data
Iterations = 1000;
InputDataStructure = '../Models/KX_Expanded_Model_TKT.mat';
...
%% Define Output
Output_Folder_Name = ['OUTPUT_FOLDER_NAME_',Date,'_TKT'];

[DataOut] = KX_Parameter_Sampling_III_TKT(Iterations,InputDataStructure,MetConcData_RAW.data(NrOfMetDataSet,:),MetConcData_RAW.textdata);
