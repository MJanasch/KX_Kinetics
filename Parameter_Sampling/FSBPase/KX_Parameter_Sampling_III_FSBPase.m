...
function [DataOut, N] = KX_Parameter_Sampling_III_FSBPase(iterations,InputDataStructure,MetConcDataIn,MetNames,seed)
...
for c = 1:iterations                    % for every interation
    ...
    [dfodc,Parameters(c,:)] = KX_CalDFODC_FSBPase(N,Parameters(c,:),vmax_K_indeces,Fluxes,SFull);
