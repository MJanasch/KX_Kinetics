...
% Created: 2017-03-22, last modified: 2021-10-13
...
%% Input data
Iterations = 1000;
InputDataStructure = '../Models/KX_Expanded_Model_BOTH.mat';
...
%% Define Output
Output_Folder_Name = ['OUTPUT_FOLDER_NAME_',Date,'_BOTH'];

[DataOut] = KX_Parameter_Sampling_III_BOTH(Iterations,InputDataStructure,MetConcData_RAW.data(NrOfMetDataSet,:),MetConcData_RAW.textdata);
