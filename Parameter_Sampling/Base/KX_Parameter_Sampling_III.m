...
function [DataOut, N] = KX_Parameter_Sampling_III(iterations,InputDataStructure,MetConcDataIn,MetNames,seed)
...
F1_MOD = 0.5;	% Multiplicative factor defining the lower bound of the sampling intervals for investigated regulatory interaction
F2_MOD = 2;     % Multiplicative factor defining the upper bound of the sampling intervals for investigated regulatory interaction
...
for c = 1:iterations                    % for every interation
    ...
    [dfodc,Parameters(c,:)] = KX_CalDFODC(N,Parameters(c,:),vmax_K_indeces,Fluxes,SFull);
            ...
            % value, therefore a Km/Ki/Ka
               ...
               for i=1:length(S)               % for every metabolite
                   if(strcmp(par_aux2,S{i}))   % if the parameter belongs to 
                    ...
                    elseif strcmp(par_aux,'KiCitratev8')
